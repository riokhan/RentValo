                            ...
                            <div className="row">
                                    ...
                                    <div className="offer-items">
                                        ...
                                        <div className="icon">
                                            <svg width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clipPath="url(#clip0_2517_1804)">
                                ...
                                <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".6s">
                                    <div className="offer-items active">
                                        ...
                                        <div className="icon">
                                            <svg width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clipPath="url(#clip0_2517_1783)">
                                    ...
                                    <div className="offer-items">
                                        ...
                                        <div className="icon">
                                            <svg width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M18.0005 25.4834C18.3177 25.4834 18.5748 25.2263 18.5748 24.9092C18.5748 24.5921 18.3177 24.335 18.0005 24.335C17.6834 24.335 17.4263 24.5921 17.4263 24.9092C17.4263 25.2263 17.6834 25.4834 18.0005 25.4834Z" fill="#384BFF" />
                                                <path d="M20.4663 25.4834C20.7835 25.4834 21.0406 25.2263 21.0406 24.9092C21.0406 24.5921 20.7835 24.335 20.4663 24.335C20.1492 24.335 19.8921 24.5921 19.8921 24.9092C19.8921 25.2263 20.1492 25.4834 20.4663 25.4834Z" fill="#384BFF" />
                                            </svg>
                                        </div>
                                        <div className="content">
                                            <h5>Watch</h5>
